...
class TestExtractLiterals:
    ...
    def test_get_file_extension_css(self):
        ...
        assert get_file_extension('<style>.test { color: red; }</style>', 'test') == '.css'
    ...
    def test_get_file_extension_html(self):
        ...
        assert get_file_extension('<h1>Title</h1><p>Content</p>', 'main_content') == '.html'
    ...
    def test_rebuild_json_from_literals(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert updated_data['modelView']['components'][0]['value'] == "<div>Modified content</div>"
